...
struct Column {
  ...
  Column(std::string column_name, DataType column_type, std::optional<std::size_t> varchar_length = std::nullopt)
      : name(std::move(column_name)), type(column_type), length(varchar_length) {}
};
